				...
				Mientras opcn <>  "22" hacer 
					...
					Segun opcn Hacer
						...
						"8"	:
							...
							tarjetasdecrédito(tarjetas)
							Esperar 2 Segundos
						"9" :
							Escribir "NegativoPositivoParImpar"
							NegativoPositivoParImpar(parIM)
							Esperar 2 Segundos
						...
						"11" :
							...
							negativopositivoparimpar2(nextPar)
							Esperar 2 segundos
						"12" :	
						...
						"13" :	
							...
							CalcularyAlUsuarioCuántosDígitosTieneDichoNum(digts)
							Esperar 2 Segundos
						"14" :	
			...
			"2": 
				...
				Segun opcn Hacer
					"1":
						...
						SecuenciaPotencias(spoten)
						Esperar 2 Segundos
					"2"	:
						Escribir "PromedioParesImpares"
						PromedioParesImpares(pImpar)
						Esperar 2 Segundos
					"3"	:
					...
					"4" :
						...
						CopiarArreglo(cARREGLO)
						Esperar 2 Segundos
						
					"5"	:
						Escribir "secuenciadenumeros"
						secuenciadenumeros(sNUMRS)
						Esperar 2 Segundos
					"6" :
						Escribir "secuenciaenArreglo"
						secuenciaenArreglo(Sarregls)
						Esperar 2 Segundos
					"7"  :
						Escribir  "lacantidaddelosnúmerosmayoresa5"
						lacantidaddelosnúmerosmayoresa5(cantMayor)
						Esperar 2 Segundos
						
					"8"	:
						Escribir "sumadecadanúmeroelevadoalcubo"
						sumadecadanúmeroelevadoalcubo(sumCUBO)
						Esperar 2 Segundos
						
					"9" :
						Escribir " cantidadDePalabra"
						cantidadDePalabra(copiPALABRA)
						Esperar 2 Segundos
						
					"10" :
						Escribir " secuenciaNumeroArreglo"
						secuenciaNumeroArreglo(sNUMarregls)
						Esperar 2 Segundos
					"11" :
						Escribir "secuenciadecaracteres"
						secuenciadecaracteres(sdeCARACTERS)
						Esperar 2 segundos
					"12" :	
						Escribir "secuenciaNumerosPares"
						secuenciaNumerosPares(SNUMpaRS)
						Esperar 2 Segundos
						
					"13" :	
						Escribir " ValoresMayor5"
						ValoresMayor5(VMayor)
						Esperar 2 Segundos
					"14" :	
					...
					"15"  :	
						...
						ValoresImpares(vIMPAt)
						Esperar 2 Segundos
						
					"16" :
						Escribir "CalcularSueldos"
						CalcularSueldos(calcularSUElds)
						Esperar 2 Segundos
						
					"17"  :
						Escribir "FraseMasLarga "
						FraseMasLarga(Flargas)
						Esperar 2 Segundos
						
					"18" :
						Escribir "ContarCaracteres"
						ContarCaracteres(contarCARACTERSTS)
						Esperar 2 Segundos
						
					"19" :
						Escribir "ContarVocalesConsonantesDigitos"
						ContarVocalesConsonantesDigitos(contarVOcals)
						Esperar 2 segundos 
						
					"20" :
						Escribir "ContarPalabras" 
						ContarPalabras(cpalabrash)
						Esperar 2 segundos
					"21" :	
						Escribir "SumaDigitosCedula"
						SumaDigitosCedula(Sdigitos)
						Esperar 2 Segundos
					...
					"23" :
						...
						PosicionDeCaracter(pCARACTERST)
						Esperar 2 Segundos
...
Funcion PagoColas(colas)
	...
	Definir colass Como Entero
	escribir "¿Cuantas colas esta comprando?"
	leer colass
	si colass >=23 Entonces
		res=colass*0.50
		sinIva=res-(res*12/100)
		Iva=res*12/100
		escribir "La cantidad comprada de colas es: ", colass
...
FinFuncion
//8
Funcion tarjetasdecrédito(tarjetas)
...
FinFuncion
//9
Funcion NegativoPositivoParImpar(parIM)
...
FinFuncion
//11
Funcion negativopositivoparimpar2(nextPar)
...
//13
Funcion  CalcularyAlUsuarioCuántosDígitosTieneDichoNum(digts)
...
//1
funcion SecuenciaPotencias(spoten)
...
funcion PromedioParesImpares(pImpar)
...
//4
Funcion  CopiarArreglo(cARREGLO)
...
Funcion secuenciadenumeros(sNUMRS)
...
//6
Funcion secuenciaenArreglo(Sarregls)
...
FinFuncion
//7
funcion  lacantidaddelosnúmerosmayoresa5(cantMayo)
...
FinFuncion
//8
Funcion sumadecadanúmeroelevadoalcubo(sumCUBO)
...
funcion cantidadDePalabra(copiPALABRA)
...
funcion secuenciaNumeroArreglo(sNUMarregls)
...
//11
funcion secuenciadecaracteres(sdeCARACTERS)
...
FinFuncion
//12
Funcion secuenciaNumerosPares(SNUMpaRS)
...
Funcion CalcularSueldos(calcularSUElds)
...
Funcion ContarCaracteres(contarCARACTERSTS)
...
Funcion ContarVocalesConsonantesDigitos(contarVOcals)
    Definir cadena Como Caracter
...
Funcion ContarPalabras(cpalabrash)
...
Funcion SumaDigitosCedula(Sdigitos)
...
Funcion PosicionDeCaracter(pCARACTERST)
